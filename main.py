...
NER_MODEL_ID = os.getenv("NER_MODEL_ID", "dslim/bert-base-NER")
...
def _chunk_text(text: str, chunk_size: int = 100):
    words = text.split()
    chunks = []
...
def _simplify_text(text: str) -> str:
    ...
    for chunk in chunks:
        ...
        simplified_chunks.append(outputs[0]["generated_text"].strip())
